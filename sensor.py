...
def test(query, sec, usec, src_ip, src_port, dst_ip, dst_port, proto, packet=None):
    ...
    result = pd.DataFrame({'ip_dst': ["23.219.88.24"], 'full_uri': ["http://www8.hp.com/us/en/scripts/framework/jquery/v-1-8/jquery.js"], 'host':["host;11"],'path':[""],'query_parameter':[0],'user_agent':["Mozilla/5.0 (Windows NT 10.0; WOW64; rv:58.0) Gecko/20100101 Firefox/58.0,optimizelyEndUserId=oeu1518298221853r0.3572298363402169; hpeuck_answ=0; __CT_Data=gpv=65&ckp=tld&dm=hp.com&apv_201_www11=65&cpv_201_www11=65&rpv_201_www11=37; OptanonConsent=landingPath=NotLandingPage&datestamp=Thu+Mar+01+2018+13%3A47%3A24+GMT-0400+(Atlantic+Standard+Time)&version=3.6.17&AwaitingReconsent=false; hp_last_segment=segment neutral; s_fid=062B1B671A74B1D1-35587F9F47AA0CC2; s_vi=[CS]v1|2D3FB2528507BD48-600001076000787D[CE]; _ga=GA1.2.1484608711.1518298286; lang=en-us; cc=us; _CT_RS_=Recording;"],'cookie':["WRUIDAWS=1611669677654091; _gid=GA1.2.118380014.1519733750,"],'accept_language':["accept_language;14"],'accept_encoding':["accept_encoding;13"],'original_accept_language':["en-US,en;q=0.5"],'original_accept_encoding':["gzip, deflate"],'original_host':["www8.hp.com"],'y':["safe"],'label':["0.0"],'ip_24':["23.219.88"]},index=[0])
    print(result)
