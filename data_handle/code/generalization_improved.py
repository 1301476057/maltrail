...
def main():
    ...
    #文件选择3
    readFile=path+'/data/lastest_some_deletesame2.csv'                         #请求泛化：输入的文件名
    wirteFile=path+'/data/test_lastest_some_deletesame2_Generalization.csv'         #请求泛化：输出的文件名
    inFile=path+'/data/test_lastest_some_deletesame2_Generalization.csv'            #去重：输入的文件名
    outFile=path+'/data/test_lastest_some_deletesame2_Generalization_deletesame.csv'#去重：输出的文件名
